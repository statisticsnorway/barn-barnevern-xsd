...
class PlanTypeTest : BehaviorSpec({
    ...
    Given("misc Plan XML") {
        ...
        forAll(
            ...
            row(
                "StartDato too early",
                "<Plan Id=\"6ee9bf92-7a4e-46ef-a2dd-b5a3a0a9ee2e\" StartDato=\"1997-12-31\" Plantype=\"1\" />",
                START_DATE_TOO_EARLY_ERROR
            ),
            row(
                "StartDato too late",
                "<Plan Id=\"6ee9bf92-7a4e-46ef-a2dd-b5a3a0a9ee2e\" StartDato=\"2030-01-01\" Plantype=\"1\" />",
