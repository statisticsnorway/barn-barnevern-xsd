...
class TilsynAnsvarligTypeTest : BehaviorSpec({
    ...
    Given("misc TilsynAnsvarlig XML") {
        ...
        forAll(
            ...
            row(
                "StartDato too early",
                "<Ansvarlig Id=\"6ee9bf92-7a4e-46ef-a2dd-b5a3a0a9ee2e\" StartDato=\"1997-12-31\" Kommunenummer=\"1234\"/>",
                START_DATE_TOO_EARLY_ERROR
            ),
            row(
                "StartDato too late",
                "<Ansvarlig Id=\"6ee9bf92-7a4e-46ef-a2dd-b5a3a0a9ee2e\" StartDato=\"2030-01-01\" Kommunenummer=\"1234\"/>",
