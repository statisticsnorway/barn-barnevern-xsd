...
class VedtakKonklusjonTypeTest : BehaviorSpec({
        ...
        forAll(
            ...
            `when`(description) {
                val thrown = shouldThrow<SAXException> {
                    getSchemaValidator().validate(buildVedtakKonklusjonTypeXml(partialXml).toStreamSource())
                }
    ...
    companion object {
        fun buildVedtakKonklusjonTypeXml(vedtakKonklusjonXml: String): String = buildBarnevernXml(
