...
class OversendelseFylkesnemndTypeTest : BehaviorSpec({
    ...
    Given("misc OversendelseFylkesnemnd XML") {
        ...
        forAll(
            ...
            row(
                "StartDato too early",
                "<OversendelseFylkesnemnd Id=\"6ee9bf92-7a4e-46ef-a2dd-b5a3a0a9ee2e\" StartDato=\"1997-12-31\">",
                START_DATE_TOO_EARLY_ERROR
            ),
            row(
                "StartDato too late",
                "<OversendelseFylkesnemnd Id=\"6ee9bf92-7a4e-46ef-a2dd-b5a3a0a9ee2e\" StartDato=\"2030-01-01\">",
