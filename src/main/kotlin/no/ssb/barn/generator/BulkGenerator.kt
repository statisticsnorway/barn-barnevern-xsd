...
class BulkGenerator {
    fun generate(fagsystemType: FagsystemType, avgiver:AvgiverType, ){

    }

    fun getFagsystem(): FagsystemType{
        return FagsystemType("SSB", "Barn Generator", "0.0.1")
    }

    fun getRandomAvgiverType() : AvgiverType {
        return listOf(
