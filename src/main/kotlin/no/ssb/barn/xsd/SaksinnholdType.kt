    ...
    companion object {
        ...
        private val codeList =
            listOf(
                ...
                CodeListItem("2", "Foreldres psykiske problem/ lidelse", validFrom2013),
                ...
                CodeListItem("20", "Foreldres manglende beskyttelse av barnet", validFrom2020),
                CodeListItem("21", "Foreldres manglende stimulering og regulering av barnet", validFrom2020),
                CodeListItem("22", "Foreldres manglende sensitivitet og følelsesmessige tilgjengelighet for barnet", validFrom2020),
                CodeListItem("23",
                    "Foreldres manglende oppfølging av barnets behov for barnehage, skole og pedagogiske tjenester",
                    validFrom2020),
                CodeListItem("24", "Konflikt mellom foreldre som ikke bor sammen", validFrom2020),
                CodeListItem("5", "Foreldres kriminalitet", validFrom2013),
                CodeListItem("6", "Høy grad av konflikt hjemme", validFrom2013),
                CodeListItem("7", "Vold i hjemmet/ barnet vitne til vold i nære relasjoner ", validFrom2013),
                CodeListItem(
                    "8",
                    "Barnet utsatt for vanskjøtsel (Barnet overlatt til seg selv, dårlig kosthold, dårlig hygiene)",
                    validFrom2013),
                CodeListItem("9", "Barnet utsatt for fysisk vold", validFrom2013),
                CodeListItem("10", "Barnet utsatt for psykisk vold", validFrom2013),
                CodeListItem("11", "Barnet utsatt for seksuelle overgrep", validFrom2013),
                CodeListItem("12", "Barnet mangler omsorgsperson", validFrom2013),
                CodeListItem("13", "Barnet har nedsatt funksjonsevne", validFrom2013),
                CodeListItem("14", "Barnets psykiske problem/lidelse", validFrom2013),
                ...
                CodeListItem("26", "Barnets kriminelle handlinger", validFrom2020),
                CodeListItem("27", "Barnet utsatt for menneskehandel", validFrom2020),
                CodeListItem("18",
        ...
        @JvmStatic
        fun getRandomCode(date: LocalDate): String = getCodes(date)
